...
namespace GraphProcessor
{
    ...
    class CreateNodeMenuWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        void CreateStandardNodeMenu(List<SearchTreeEntry> tree)
        {
            ...
            var nodeEntries = graphView.FindCreateNodeMenuEntries().OrderBy(k => k.path);
        ...
        public bool OnSelectEntry(SearchTreeEntry searchTreeEntry, SearchWindowContext context)
        {
            ...
            var view = graphView.AddNode(NodeProvider.CreateNodeFromType(nodeType, graphMousePosition));
